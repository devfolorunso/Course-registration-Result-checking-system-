    ...
    <!-- Nav Item - Charts -->
      ...
      <li class="nav-item">
        <a class="nav-link" href="view-courses-i.php">
          <i class="fa fa-eye"></i>
          <span>View Register Coursesed</span></a>
      </li>
        ...
        <a class="nav-link" href="print-courses-i.php">
          ...
          <span>Print Register Coursesed</span></a>
      </li>
            ...
            <div class="col-xl-10 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Edit Registered Courses</h6>
         ...
         <input type="hidden" name="token" value="<?php echo Token::generate();?>">
           ...
           <div class="row" style="margin-top: 5%;">
                ...
                ?>
                  ...
                  <script>
                     setTimeout(function(){
                    window.location.href= "edit-choice.php?semester=<?php echo $semester;?>&&session=<?php echo $session; ?>";
                    }, 700);
                  </script>
