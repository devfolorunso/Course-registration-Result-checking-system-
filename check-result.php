            ...
            <div class="col-xl-10 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Check Results</h6>
    ...
    <div class="row">
      ...
      <div class="col-md-1"></div>
       ...
       <div class="col-md-10">
        ...
        <?php include 'process/checkResultProcess.php';?>
      ...
      <div class="col-md-2"></div>
        <div class="card shadow mb-4 col-md-8">
          ...
          <div class="card-header py-3">
             ...
             <a class="float-right" href="print-result.php?session=<?php echo input::get('session');?>&&matric_no=<?php echo $matric_no;?>&&semester=<?php echo input::get('semester');?>">Print Result <i class="fa fa-print"></i></a>
          </div>
