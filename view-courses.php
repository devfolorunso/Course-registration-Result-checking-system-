            ...
            <div class="col-xl-10 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Courses You Registered</h6>

                  <div class="dropdown no-arrow">
                    <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                       <a class="float-right" href="print-course-list.php?semester=<?php echo $semester;?>&&session=<?php echo $session; ?>"><i class="fa fa-print"></i> Print Course List </a>
                    </a>
                  </div>
                </div>
                        ...
                        <div class="row" style="margin-top: 5%;">
                          <div class="col-md-6">
                             <div class="form-group">
                                <a class="text-decoration-none" href="edit-choice.php?semester=<?php echo $semester;?>&&session=<?php echo $session; ?>"><button type="link" class="btn btn-primary btn-user btn-block" style="float: right;"><i class="fa fa-edit"></i>Edit</button></a>
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                             <div class="form-group">
                                 <a class="text-decoration-none" href="print-course-list.php?semester=<?php echo $semester;?>&&session=<?php echo $session; ?>"><button type="link" class="btn btn-success btn-user btn-block" style="float: right;"><i class="fa fa-print"></i> Print</button> </a>
                              </div>
                          </div>
