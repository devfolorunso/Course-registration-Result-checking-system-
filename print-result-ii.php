          ...
          <div class="col-xl-10 col-lg-5">
            <div class="card shadow mb-4">
              ...
              <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Your Result For <?php echo $semester .' '. $session . ' Session';?></h6>
              </div>
                          ...
                          ?>
                            <tbody>
                              <tr>
                                ...
                                <td>
                                  <?php echo $sql->course_code;?>
                                    
                                </td>

                                <td>
                                  <?php echo $sql->course_unit;?>
              ...
              <div class="row" style="margin-top: 5%;">
                <div class="col-md-6">
                   <div class="form-group">
                      <a class="text-decoration-none" href="index.php?semester=<?php echo $semester;?>&&session=<?php echo $session; ?>"><button type="link" class="btn btn-primary btn-user btn-block" style="float: right;"><i class="fa fa-home"></i> Go Back</button></a>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                   <div class="form-group">
                       <a class="text-decoration-none" href="print-result.php?semester=<?php echo $semester;?>&&session=<?php echo $session; ?>"><button type="link" class="btn btn-success btn-user btn-block" style="float: right;"><i class="fa fa-print"></i> Print</button> </a>
                    </div>
                </div>
