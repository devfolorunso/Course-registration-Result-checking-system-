            ...
            <div class="col-xl-10 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Remove Course(S)</h6>
                ...
                foreach ($course->results() as $course)
                  {
                    ...
                    <div class="form-group "> 
                      ...
                      <?php echo $course->course_unit;?>
                       ...
                       <td>
                     <a href="delete-course.php?regcourse_id=<?php echo $course->regcourse_id;?>&&session=<?php echo $session;?>&&semester=<?php echo $semester;?>"><button class="btn-link"><i class="fas fa-trash"></i></button></a>
                      </td>
                    </tr>
                    </div>
                  <?php
                  ...
                  {?>
                    ...
                    <i class="fa fa-volume-up"></i> Hey!  There is nothing here!
                  <?php 
                  }
                  ?>
                  </tbody>
