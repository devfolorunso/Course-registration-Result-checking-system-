        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Courses</h1>
             <a href="upload-course.php" class="btn btn-light btn-icon-split">
                    <span class="icon text-gray-600">
                      <i class="fas fa-arrow-right"></i>
                    </span>
                    <span class="text">Fast Alternative</span>
                    <span class="icon text-gray-600">
                      <i class="fas fa-arrow-right"></i>
                    </span>
                </a>
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">        
                      <?php 
                      include 'process/addCourseProcess.php';
                      ?>
    
          <form class="user" id="courseform" method="POST" action="">
              ...
              <input type="hidden" name="token" value="<?php echo Token::generate();?>">
                      ...
                      <div class="row" style="margin-top: 5%;">
                            <div class="col-md-6">
                              <div class="form-group">
                                  <input type="submit" class="form-save btn btn-primary btn-user btn-block" value="SUBMIT">
                              </div>
                      </div>
