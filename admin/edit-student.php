 ...
 <div class="container">
    ...
    <?php 
     ...
     if (Token::check(Input::get('token'))) {
       ...
       $update = DB::getInstance()->update('tblstudents', $students_id, array(
        ...
        if ($update){
         ...
         echo "Unable to update";
                  ...
                  <div class="row">
                    <?php include 'process/toupdate.php'?>
                    <div class="col-md-6">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                    	<input type="text" class="form-control form-control-user" name="programme" value="<?php echo $updateprogramme?>" readonly> 
                      </div>
                    </div>
