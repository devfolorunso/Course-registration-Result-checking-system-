        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Add Courses</h1>
                         <a href="add-course.php" class="btn btn-light btn-icon-split">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Upload Course</h6>
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">        
                <?php
                include 'process/uploadCourseProcess.php';
                ?>        
<form class="user" id="course" method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="file" name="courselist" class="form-control text-danger">
