...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="course-registration.php">
            ...
            <div class="col-xl-10 col-lg-5">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">HOW WOULD LOVE TO EDIT YOUR COURSES?</h6>
       ...
       <div class="col-md-10">
          ...
          <form class="user" method="POST" action="">
            ...
            <div class="form-group">
              <input type="radio" name="choice" value="Re-register"/> Delete The Previous Courses I want to Re- Register Them
            </div> 

              <div class="form-group">
                <input type="radio" name="choice" value="Remove"/> I Just Want To Remove Some Course(s)
              </div>

              <div class="form-group">
                <input type="radio" name="choice" value="Add"/> I  Want To Add Some Course(s)
              </div>
      ...
      <?php
       if (Input::exists())
        { 
         ...
         if (input::get('choice') == 'Re-register')
         {
            
            echo'
              <script>
               window.alert("This Action Will Delete Your Registered Courses For This Semester! DO YOU WANT TO CONTINUE?");
               window.location.href="Re-register-course.php?semester='.$semester.'&&session='.$session.'";
              </script>
            ';
          }

            else if(input::get('choice') == 'Remove')
            {
              echo'
                <script>
